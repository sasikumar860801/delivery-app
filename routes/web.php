...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('manage')->group(function () {
            ...
            Route::put('/delivery-partners/{id}/status', [AdminController::class, 'updateDeliveryPartnerStatus']);
...
Route::prefix('delivery')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::put('/tasks/{id}/status', [DeliveryPartnerController::class, 'updateTaskStatus']);
...
Route::prefix('customer')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::put('/cart/{id}', [CustomerController::class, 'updateCartItem']);
